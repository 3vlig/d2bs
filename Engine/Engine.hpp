...
public:
	...
	inline void RegisterConstructor(JSClass* classp, JSObject* ctor) { constructors[classp] = ctor; }
	EXPORT inline JSObject* GetConstructor(JSClass* classp) { return constructors.count(classp) > 0 ? constructors[classp] : nullptr; }
